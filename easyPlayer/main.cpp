...
class MainState {
    ...
    QApplicationWatcher<QApplication> * _v_application=nullptr;
...
public:
    ...
    auto * app() const { return _v_application->get(); }
public:
...
inline MainState::MainState(int argc,char **argv) {
    ...
    _v_application=new QApplicationWatcher<QApplication>(argc,argv);
    /*init gctimer*/
