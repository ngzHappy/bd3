...
#include <Qt/boost/optional.hpp> // to store locale when needed

#include <Qt/boost/format/format_fwd.hpp>
#include <Qt/boost/format/internals_fwd.hpp>
#include <Qt/boost/format/internals.hpp>
#include <Qt/boost/format/alt_sstream.hpp>
